...
beforeEach(function () {
    ...
    $this->operation = new CampaignRead(
        $this->client,
        $this->logger,
    );
...
it('maps request correctly', function () {
    ...
    $request = (new CampaignRead($this->client, $this->logger))->requestMapper($dto, '1234567890');
...
it('maps response correctly', function () {
    ...
    $operation = new CampaignRead($this->client, $this->logger);
...
describe('CampaignRead::perform validation', function () {
