          ...
          <div className="col col--12">
            <header>
              ...
              <p className="margin-bottom--sm">
                ...
                adapters and tests you’ll wire to your app and the provider SDK. Outside the <strong>DTO → Adapter → Gateway</strong> pattern, 
