...
namespace Plenipotentiary\Laravel\Pleni\Google\Ads\Contexts\Search\Campaign\DTO\External;

use Google\Ads\GoogleAds\V20\Enums\CampaignStatusEnum\CampaignStatus;
use Google\Ads\GoogleAds\V20\Resources\Campaign as GoogleAdsCampaign;
...
class CampaignExternalDTO implements \JsonSerializable
{
    ...
    public static function fromGoogleResponse(GoogleAdsCampaign $remote): self
    {
        return new self(
