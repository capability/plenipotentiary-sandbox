...
/**
 * Small helper that encapsulates the provider-specific budget creation call used by CampaignCreate.
 *
 * Keeping this logic here makes CampaignCreate easier to scan while still exposing the
 * exact Google Ads SDK usage we rely on when a caller does not provide an existing budget.
 */
class CampaignCreateBudget
{
